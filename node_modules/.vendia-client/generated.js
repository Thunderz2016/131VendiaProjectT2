...
exports.Test__getDocument = (0, graphql_tag_1.default) `
  ...
  get_Test(id: $id, version: $version, readMode: $readMode) {
    ...
    `;
exports.Device__getDocument = (0, graphql_tag_1.default) `
...
exports.Test__listDocument = (0, graphql_tag_1.default) `
  ...
  list_TestItems(
    ...
    `;
exports.Device__listDocument = (0, graphql_tag_1.default) `
...
exports.Test__updateDocument = (0, graphql_tag_1.default) `
  ...
  update_Test(
    ...
    `;
exports.Device__addDocument = (0, graphql_tag_1.default) `
  ...
  add_Device(input: $input, syncMode: $syncMode, aclInput: $aclInput) {
    ...
    `;
exports.Device__putDocument = (0, graphql_tag_1.default) `
  ...
  put_Device(
    ...
    `;
exports.Device__updateDocument = (0, graphql_tag_1.default) `
...
exports.Test__removeDocument = (0, graphql_tag_1.default) `
  ...
  remove_Test(id: $id, syncMode: $syncMode, condition: $condition) {
    ...
    `;
exports.Device__removeDocument = (0, graphql_tag_1.default) `
...
exports.Test__onUpdateDocument = (0, graphql_tag_1.default) `
  ...
  onUpdate_Test {
    ...
    `;
exports.Device__onAddDocument = (0, graphql_tag_1.default) `
  ...
  onAdd_Device {
    ...
    `;
exports.Device__onRemoveDocument = (0, graphql_tag_1.default) `
  ...
  onRemove_Device {
    ...
    `;
exports.Device__onUpdateDocument = (0, graphql_tag_1.default) `
    ...
    return {
        ...
        device: {
            get(idOrOptions, options) {
                const variables = typeof idOrOptions === 'string' ? { ...options, id: idOrOptions } : { ...options, ...idOrOptions };
                return _requestWrapper((wrappedRequestHeaders) => {
                    return _gqlClient.request(exports.Device__getDocument, variables, wrappedRequestHeaders)
            ...
            list(options) {
                const variables = options;
                return _requestWrapper((wrappedRequestHeaders) => {
                    return _gqlClient.request(exports.Device__listDocument, variables, wrappedRequestHeaders)
            ...
            add(input, options) {
                const variables = { ...options, input };
                return _requestWrapper((wrappedRequestHeaders) => {
                    return _gqlClient.request(exports.Device__addDocument, variables, wrappedRequestHeaders)
            ...
            put(input, options) {
                ...
                const variables = { ...options, id: _id, input: rest };
                return _requestWrapper((wrappedRequestHeaders) => {
                    return _gqlClient.request(exports.Device__putDocument, variables, wrappedRequestHeaders)
            ...
            update(input, options) {
                ...
                const variables = { ...options, id: _id, input: rest };
                return _requestWrapper((wrappedRequestHeaders) => {
                    return _gqlClient.request(exports.Device__updateDocument, variables, wrappedRequestHeaders)
            ...
            remove(idOrOptions, options) {
                const variables = typeof idOrOptions === 'string' ? { ...options, id: idOrOptions } : { ...options, ...idOrOptions };
                return _requestWrapper((wrappedRequestHeaders) => {
                    return _gqlClient.request(exports.Device__removeDocument, variables, wrappedRequestHeaders)
                        .then(res => res.remove_Device);
                }, 'remove_Device');
            },
            onAdd(handler) {
                return _subscribe({ query: exports.Device__onAddDocument }, ({ data }) => { return handler(data.onAdd_Device); });
            },
            onRemove(handler) {
                return _subscribe({ query: exports.Device__onRemoveDocument }, ({ data }) => { return handler(data.onRemove_Device); });
            },
            onUpdate(handler) {
                return _subscribe({ query: exports.Device__onUpdateDocument }, ({ data }) => { return handler(data.onUpdate_Device); });
            }
        }
    };
}

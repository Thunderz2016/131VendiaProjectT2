...
import { Table, Thead, Tbody, Tr, Th, Button, Td } from "@chakra-ui/react";
        ...
        <Table>
          ...
          <Tbody>
            {testList.map((test, index) => (
              // EditablePreview needs width="full" to account for empty default values,
              // otherwise the editable isn't clickable.
              <Tr key={index}>
                <Td>
